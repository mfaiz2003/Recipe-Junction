...
function Explore() {
  ...
  return (
    ...
    {/* nonveg */}
        ...
        <div className='flex justify-evenly  flex-col md:flex-row mx-10 mt-14 slide-right fade-delay-5 shadow-xl shadow-white rounded-3xl py-3 '>
  
        <div className="relative w-full md:w-[350px] lg:w-[500px] h-[250px] md:h-[300px] lg:h-[350px] flex justify-center">
          ...
          <div className="absolute top-0 left-0 md:left-[-20px] w-[250px] md:w-[350px] h-[250px] md:h-[350px] rounded-4xl bg-white shadow-xl transform rotate-[-8deg] z-0">
            <img src={image1} alt="dessert1" className="w-full h-full object-cover rounded-4xl" />
          </div>
          ...
          <div className="w-full md:w-1/2 flex flex-col  items-center md:justify-center justify-center text-white py-3">
            ...
            <p className='flex mt-4 sm:mt-6 px-4 sm:px-6 font-light text-justify sm:text-lg md:text-2xl'>"A flavorful delight for meat lovers — tender, juicy chicken slow-cooked with aromatic spices,
    ...
    {/* veg */}
      ...
      <div className='flex justify-evenly flex-col-reverse md:flex-row mx-10 mt-14 slide-right fade-delay-5 shadow-xl shadow-white rounded-3xl py-3'>
          ...
          <div className="w-full md:w-1/2 flex flex-col  items-center md:justify-center justify-center  py-3 text-white">
            ...
            <p className='flex mt-4 sm:mt-6 px-4 sm:px-6 font-light text-justify sm:text-lg md:text-2xl'>"Celebrate the vibrant flavors of nature’s finest ingredients. From garden-fresh veggies to wholesome, hearty meals —
          ...
          <div className="flex justify-center mt-6 md:mt-10">
            <button className="smooth-gradient-btn transition-transform duration-300 md:px-8 px-4 py-2 text-lg md:text-2xl text-white rounded-xl shadow-xl hover:scale-110" onClick={() => navigate("/veg")}>Check Out</button>
          </div>
         </div>
      ...
      <div className='flex justify-evenly  flex-col md:flex-row mx-10 mt-14 slide-right fade-delay-5 shadow-xl shadow-white rounded-3xl py-3 '>
        ...
        <div className="relative w-full md:w-[350px] lg:w-[500px] h-[250px] md:h-[300px] lg:h-[350px] flex justify-center">
          ...
          <div className="w-full md:w-1/2 flex flex-col  items-center md:justify-center justify-center text-white py-3">
            ...
            <p className='flex mt-4 sm:mt-6 px-4 sm:px-6 font-light text-justify sm:text-lg md:text-2xl'>“Dive into a bowl of freshness and crunch, Where every leaf, fruit, and nut comes alive with flavor.
