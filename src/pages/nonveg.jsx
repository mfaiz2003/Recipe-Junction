...
function Nonveg(){
    ...
    <div className='bg-[#0C104E]'>
        ...
        <div className="flex justify-between w-full md:w-full gap-10 py-4 px-10 md:px-10 flex-col md:flex-row mt-3">
            ...
            <div className='w-full md:w-96 h-full flex flex-col items-center rounded-4xl bg-white sticky top-0 z-0'>
        ...
        <div className="flex justify-between w-full md:w-full gap-10 py-4 px-10 md:px-10 flex-col md:flex-row mt-3">
            <div className='w-full h-full md:w-64 flex flex-col items-center rounded-4xl bg-white sticky top-0 z-0'>
